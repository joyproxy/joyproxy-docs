...
在 IDE 或聊天集成中生成动态代理端点、查询余额并获得配置帮助：
...
参见 <a href="best-practices/integrate-proxies-in-ai.md" target="_blank" rel="noopener noreferrer">最佳实践 → 在 AI 中集成代理</a>。

## 选择入门路径

| 若您需要… | 从这里开始 |
| --- | --- |
| 轮换（共享网关） | <a href="getting-started/rotating/quick-start.md" target="_blank" rel="noopener noreferrer">动态代理 → 快速开始</a> |
...
| Chrome / Edge / 测试器 / Android | <a href="getting-started/software/README.md" target="_blank" rel="noopener noreferrer">软件工具</a> |
...
- **产品与服务** — 动态 / 静态 / 自定义 / 网页抓取 API（各产品以**快速开始**起）；**软件工具**按各客户端独立指南阅读。
- **最佳实践** — AI、<a href="best-practices/openapi-center.md" target="_blank" rel="noopener noreferrer">OpenAPI 中心</a>、第三方工具、Windows / Chrome / 移动端配置模式。
