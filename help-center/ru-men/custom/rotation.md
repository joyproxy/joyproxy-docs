...
1. <a href="https://www.joyproxy.com/admin-my-orders.html" target="_blank" rel="noopener noreferrer">我的代理 → Custom Proxies</a>。
2. 选择端口。
3. 点 **Rotation**。
...
> **重要**
>
> 请先 <a href="assign-region.md" target="_blank" rel="noopener noreferrer">分配地区</a>，再开定时轮换，换出的 IP 才会留在所选地域内。

控制项在「我的代理」。连接时仍用已生成的 host 与 port。

需要立刻换出口、不按时间表：用 <a href="new-ip.md" target="_blank" rel="noopener noreferrer">更换 IP</a>。
