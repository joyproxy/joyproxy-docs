...
将 `GENERATED_USER` 替换为 [Endpoints](https://www.joyproxy.com/admin-ip-extraction-center.html) 的用户名，将 `YOUR_PASS` 替换为 [Users & Whitelist](https://www.joyproxy.com/admin-authorization.html) Username/Password。主机与端口保持 `gate.joyproxy.com:9001`。
...
[在应用与浏览器中使用](apps-and-browsers.md) · [协议](protocols.md) · [响应码](response-codes.md)
