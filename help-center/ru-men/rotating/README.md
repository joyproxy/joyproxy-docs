...
3. [网络类型](network-types.md) — 住宅、移动、商业/ISP 网络选型对比
4. [购买流量](purchase.md) — 选择网络类型与购买 GB 流量包
...
13. [查询用量](usage.md) — 查看流量消耗明细与趋势图表
14. [查询支付记录与下载凭证](payments-and-invoices.md) — 交易流水与 PDF 收据下载
