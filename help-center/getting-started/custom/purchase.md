...
| 3 | 选有效期（单价按端口计） |
| 4 | 填**端口数量**并结账 |
| 5 | 在 <a href="https://www.joyproxy.com/admin-my-orders.html" target="_blank" rel="noopener noreferrer">我的代理（My Proxies） → Custom</a> 查看 |

城市在**付款后**再分配，不必像静态那样下单就锁死一个国家。

建议开启 <a href="auto-renew.md" target="_blank" rel="noopener noreferrer">自动续费（Auto-renew）</a>，到期前从余额续期。
