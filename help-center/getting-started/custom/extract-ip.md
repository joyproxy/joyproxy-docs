...
1. 登录控制台，进入左侧菜单 **[提取（Endpoint Generator）](https://www.joyproxy.com/admin-ip-extraction-center.html)** 页面。
...
> 💡 **OpenAPI 中心引流**  
> JoyProxy 提供了完善的 RESTful API 支持。请参阅 **[OpenAPI 中心](../../best-practices/openapi-center.md)** 中的自定义代理提取与控制接口文档。
