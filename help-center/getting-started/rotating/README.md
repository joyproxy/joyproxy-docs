...
7. <a href="extract-ip.md" target="_blank" rel="noopener noreferrer">提取代理 IP</a> — Web 提取、API 提取与 AI 提取
8. <a href="extraction-parameters.md" target="_blank" rel="noopener noreferrer">高级提取参数</a> — 国家/州/市/ASN 定向、会话控制与格式
9. <a href="first-request.md" target="_blank" rel="noopener noreferrer">发起代理请求</a> — 常用编程语言示例与客户端配置
...
12. <a href="usage.md" target="_blank" rel="noopener noreferrer">查询用量</a> — 查看流量消耗明细与趋势图表
13. <a href="payments-and-invoices.md" target="_blank" rel="noopener noreferrer">查询支付记录与下载凭证</a> — 交易流水与 PDF 收据下载
