...
1. 登录控制台，进入 **[提取（Endpoint Generator）](https://www.joyproxy.com/admin-ip-extraction-center.html)** 页面。
...
1. 在 **[提取（Endpoint Generator）](https://www.joyproxy.com/admin-ip-extraction-center.html)** 页面点击 **API 提取（API Generator）** 页签。
...
- 在 **[提取（Endpoint Generator）](https://www.joyproxy.com/admin-ip-extraction-center.html)** 页面点击 **AI 提取（AI Generator）** 了解详情。
