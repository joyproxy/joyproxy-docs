# Whitelist & Users (Static)

Same authorization rules apply to long-term and custom residential proxies.

Before using any long-term  proxy, configure at least one auth method in [Whitelist & Users](https://www.joyproxy.com/admin-authorization.html).
