# Integrate Static Proxies in Code

Static endpoints stay stable — reuse the same host:port from the generator.
...
**🔗 API generation**Use `/v1/extract-long` with `allocation_id` — see [OpenAPI Center](https://www.joyproxy.com/admin-openapi.html).
