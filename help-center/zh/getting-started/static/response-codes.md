...
- **排查**：先运行 `curl -x ... https://api.ipify.org`。若 ipify 能正常返回 IP，说明代理连通正常，报错系目标网站防护拦截。建议使用 **<a href="refresh-ip.md" target="_blank" rel="noopener noreferrer">更换 IP</a>** 刷新该线路的出口 IP。
