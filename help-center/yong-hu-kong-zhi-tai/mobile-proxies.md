...
运营商蜂窝出口，现网仅 **动态** 预付流量（`modes: Rotating`），无静态/自定义模式切换。

| 项目 | 说明 |
| --- | --- |
| 侧栏入口 | **移动代理控制台**（`sidebar.proxyMobile`） |
| 控制台页顶 | **移动代理** — 4G / 5G 蜂窝网络 IP，适用于移动端场景。 |
| 页眉 kicker | **代理控制台**（`proxyConsole.kicker`） |
| 地址 | <a href="https://www.joyproxy.com/admin-proxy-mobile.html" target="_blank" rel="noopener noreferrer">https://www.joyproxy.com/admin-proxy-mobile.html</a> |
| 产品页 | <a href="https://www.joyproxy.com/products/proxy-mobile.html" target="_blank" rel="noopener noreferrer">https://www.joyproxy.com/products/proxy-mobile.html</a> |
...
| 模式 | 文案 | 产品文档 |
| --- | --- | --- |
| 动态 | **动态** | <a href="../getting-started/rotating/README.md" target="_blank" rel="noopener noreferrer">动态代理</a>（<a href="../getting-started/rotating/network-types.md" target="_blank" rel="noopener noreferrer">网络类型</a> — 移动） |
...
详见 <a href="../getting-started/rotating/purchase.md" target="_blank" rel="noopener noreferrer">购买流量</a>（移动网络见 <a href="../getting-started/rotating/network-types.md" target="_blank" rel="noopener noreferrer">网络类型</a>）。
...
详见 <a href="../getting-started/rotating/view-traffic.md" target="_blank" rel="noopener noreferrer">查看已购流量</a>、<a href="../getting-started/rotating/auto-buy-traffic.md" target="_blank" rel="noopener noreferrer">自动购买流量</a>。
