...
**商业 / ISP**（`sidebar.proxyBusiness`）面向企业 ISP ASN 出口（`overview.businessDescShort`：**独享 ISP 线路 — 静态与定制**）。购买与提取支持 **动态**、**静态独享**、**自定义独享** 三种模式（与住宅控制台页签结构相同）。

[进入控制台](https://www.joyproxy.com/admin-proxy-business.html) · [产品介绍](https://www.joyproxy.com/products/proxy-business.html)
...
在 **购买** 页签先确认网络为 **商业 / ISP**，再选择 **动态** / **静态独享** / **自定义独享**。

各模式操作分别对应 [动态代理](../getting-started/rotating/README.md)、[静态独享](../getting-started/static/README.md)、[自定义独享](../getting-started/custom/README.md) 文档。
...
- 动态：[自动购买流量](../getting-started/rotating/auto-buy-traffic.md)
- 静态 / 自定义：[自动续费](../getting-started/static/auto-renew.md) 与对应产品文档
