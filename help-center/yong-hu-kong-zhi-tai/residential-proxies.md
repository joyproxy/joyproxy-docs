...
家庭宽带风格出口，支持 **动态** 流量包、**静态独享** 与 **自定义独享**。

<a href="https://www.joyproxy.com/admin-proxy-residential.html" target="_blank" rel="noopener noreferrer">打开控制台</a> · <a href="https://www.joyproxy.com/products/proxy-residential.html" target="_blank" rel="noopener noreferrer">产品介绍</a>
...
- 自定义：<a href="../getting-started/custom/auto-renew.md" target="_blank" rel="noopener noreferrer">自动续费</a>、<a href="../getting-started/custom/rotation-and-refresh.md" target="_blank" rel="noopener noreferrer">轮换与更换 IP</a>
...
- 动态：<a href="../getting-started/rotating/extract-ip.md" target="_blank" rel="noopener noreferrer">提取 IP</a>、<a href="../getting-started/rotating/extraction-parameters.md" target="_blank" rel="noopener noreferrer">高级参数</a>
- 静态 / 自定义：<a href="../getting-started/static/extract-ip.md" target="_blank" rel="noopener noreferrer">静态提取</a>、<a href="../getting-started/custom/extract-ip.md" target="_blank" rel="noopener noreferrer">自定义提取</a>

---

## 用量

- 动态：<a href="../getting-started/rotating/view-traffic.md" target="_blank" rel="noopener noreferrer">已购流量</a>、<a href="../getting-started/rotating/usage.md" target="_blank" rel="noopener noreferrer">查询用量</a>
- 独享：<a href="../getting-started/static/view-lines.md" target="_blank" rel="noopener noreferrer">已购线路</a>、<a href="../getting-started/custom/view-ports.md" target="_blank" rel="noopener noreferrer">管理端口</a>
