...
**数据中心**（`sidebar.proxyDatacenter`）提供托管 ASN 出口（`overview.datacenterDescShort`：**高吞吐托管 ASN 端点**）。通常使用 **静态独享** 与 **自定义独享**；动态轮换请使用住宅、移动或商业网络。

[进入控制台](https://www.joyproxy.com/admin-proxy-datacenter.html) · [产品介绍](https://www.joyproxy.com/products/proxy-datacenter.html)
...
在 **购买** 页签选择 **静态独享** 或 **自定义独享**（无动态模式时界面仅展示可用项）。
